            ...
            <tbody>
              {sortedSales.map(o => (
                <tr key={o.order_id}>
                  ...
                  <td data-label="Fecha">{formatDate(o.date_created)}</td>
                  ...
                  <td data-label="Domicilio" style={{ fontSize: '0.8rem', maxWidth: '220px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }} title={o.buyer?.address || ''}>
                    {o.buyer?.address || '-'}
                  </td>
                  <td data-label="CAE">
                    <div>{o.afip_cae || '-'}</div>
