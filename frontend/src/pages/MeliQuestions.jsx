      ...
      <div style={{ backgroundColor: 'var(--bg-card, #1f2937)', borderRadius: 12, border: '1px solid var(--border-color, #374151)', overflow: 'hidden' }}>
        {loading ? (
          ...
          <div style={{ overflowX: 'auto' }}>
            <table className="mobile-cards" style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '0.88rem' }}>
              <thead>
              ...
              <tbody>
                {questions.map((q) => (
                  <tr key={q.id || q.question_id} style={{ borderBottom: '1px solid var(--border-color, #374151)' }}>
                    <td data-label="Publicación / Comprador" style={{ padding: '14px 16px', maxW: 240 }}>
                    ...
                    <td data-label="Respuesta Gemini AI" style={{ padding: '14px 16px', maxWidth: 350 }}>
                      {q.answer_text ? (
                        <div>
