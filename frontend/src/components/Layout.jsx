    ...
    <>
      ...
      {isChannelEnabled('meli') && meliStatus && (
        <div 
          ...
          title={meliStatus.is_authenticated ? `Cuenta vinculada: ${meliStatus.nickname || meliStatus.user_id}${meliStatus.email ? ` (${meliStatus.email})` : ''}. Hacé clic para administrar en Configuración.` : "¡Hacé clic para vincular tu cuenta de Mercado Libre!"}
          style={{
            display: 'inline-flex',
            alignItems: 'center',
            gap: '8px',
