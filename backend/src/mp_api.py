...
def sync_mp_payments(date_from=None, limit=100):
    """
    Fetches approved payments from Mercado Pago API, maps them to orders_cache,
    registers buyer info into customers table, extracts fee_details into variable_expenses,
    ...
    try:
        ...
        for p in results:
            ...
            # Determine platform subtype
            source_platform = 'MERCADOPAGO'
            if payment_type == 'bank_transfer' or payment_method_id in ['pix', 'cvu', 'account_money']:
            ...
            elif operation_type == 'regular_payment' and p.get('description'):
            ...
            # Fee details extraction (Commissions & Retentions)
            ...
            if items_raw:
                for it in items_raw:
                    ...
                    # Try matching with products_cache by ml_id or title
                    matched_prod = None
                    if item_id:
